...
/**
 * Clase que alberga la tabla con los aviones del aeropuerto 
 * 
...
public class TablalistaAvionesAeropuerto extends JPanel {
	...
	//Declaración de una variable estatica
	...
	/**
	 * Método para poner en la tabla los valores del listado de aviones del aeropuerto  
	 */
